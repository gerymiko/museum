...
<body id="body" class="hold-transition skin-dark layout-top-nav">
	<div class="wrapper">
				...
				<div class="error-page">
					...
					<div class="error-content">
						...
						<p class="text-white">
							...
							Meantime, you can return to <br><a href="<?=site_url()?>../../home"><b>Homepage</b></a>
						</p>
					</div>
				</div>
			</section>
		...
		<footer class="main-footer">
			...
			<div class="container">
				Copyright &copy; <?=date("Y");?> <strong><a class="text-orange ls1" href="#">DINAS KEBUDAYAAN SAMARINDA</a></strong>
			</div>
		</footer>
	</div>
