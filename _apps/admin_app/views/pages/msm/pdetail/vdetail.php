<section class="content-header">
	<h1>Detail Kategori <small>Aplikasi Museum Samarinda</small> <button class="btn btn-sm pull-right bg-pusam" data-toggle="modal" data-target="#modal-add-detail">+ Tambah</button></h1>
</section>
	...
	<div class="box no-radius desktop" id="content-filter">
		<div class="box-body">
			<form id="form-filter" action="#" class="form-horizontal">					
				...
				<div class="col-md-3">
	                <div class="form-group" style="margin-bottom: 0;">
                        <input type="text" class="form-control _CalPhaNum" id="detail_search" placeholder="Nama Detail" maxlength="30">
					</div>
	            </div>
	            <div class="col-md-3">
					<div class="form-group" style="margin-bottom: 0;">
      	...
      	<div class="modal-content">
         	...
         	<form id="form-add-detail" method="post" action="#" enctype="multipart/form-data" >
	            		...
	            		<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control datemask required" data-mask>
								</div>
							</div>
							<div class="form-group">
	            ...
	            <div class="modal-footer no-border">
	               ...
	               <button type="submit" id="btn_add_detail" class="btn btn-danger" >Simpan</button>
	            </div>
	        </form>
      	</div>
   	</div>
...
<script type="text/javascript">
	$(document).ready(function (){
		...
		var table = $('#table_detail').DataTable({
			...
			"ajax": {
				"url" : '<?=site_url()?>../../table/detail',
				"type" : 'POST',
				data : function(data){ data.category_search = $("#category_search").val();data.detail_search = $("#detail_search").val();data.status_search = $("#status_search").val();data.type_search = $("#type_search").val();},
	...
	function removeData(id, name){
	    swal({
			...
			if (result.value){
			    $.ajax({
					url: "<?=site_url()?>../../save/delete/detail",
					type: "post",
